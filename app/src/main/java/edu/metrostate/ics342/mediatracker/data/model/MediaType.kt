...
fun MediaType?.toIconRes(): Int = when (this) {
    MediaType.BOOK  -> edu.metrostate.ics342.mediatracker.R.drawable.ic_smart_display
    MediaType.MOVIE -> edu.metrostate.ics342.mediatracker.R.drawable.ic_smart_display
    else            -> edu.metrostate.ics342.mediatracker.R.drawable.ic_smart_display
}