...
> Your answer:https://github.com/BrianWill2026/media-tracker-android/tree/week-04
> 
> I would say this one because it was the point of the semester where it started to get hard for me. I personally struggled with this course mainly because I didn't ask for enough help but also I think It was either too fast or I was not at my skill level. 
...
> Your answer: I would say the login screen because It was the screen that I got closest to the 100% intended function as well as what we did first. Even though you said not perfect aspect it is what I think. For the first couple of weeks I was more following along because there was just to0 much to take in for class. But It was one of the first times I really tried to poke around, looks at stackoverflow, and experiment. 
...
> Your answer: My Library
> I never got it 100% I definitely started to fall behind here, but it was not getting the items that I needed, and specifically I just wanted to have all the images populate on the screen as I am a visual person.
...
> Your answer: Tying in my session that you provided us because I had to leave and thought I would be fine. 
> I just missed a simple step that I needed to be there for. 
...
> Your answer (include code): local.properties
> sdk.dir=C\:\\Users\\Brian Willems\\AppData\\Local\\Android\\Sdk 
> apiClientId=ics342-brian-willems 
...
> Your answer: I learned more about logic in this class in the specific crazy that is kotlin and android development. I sort of understood composed as it was a central part, but I really wanted to play in a more basic aspect to grasp a central part of it.
> In my mind it is like a widget from flutter being the cornerstone that we build around.
> 
...
> Your answer: Reflection 2 - I said file structure. I am not as confused as I have more experience with it now having to page through it multiple time. 
> I didn't understand at the time what the logic was to it now is more or less arbitrary as long as the app can find it and that I can find it easily. I made friends with the file search function eventually which helped a lot.
...
> Your answer: I realized that I had a hard time expressing what I was learning by the depth he was going to. I realized that I should start taking some notes to help express myself.
...
> Your answer:
> I made the review feature;
> Just like making a comment on new or music you publish it for others to read or listen to.
> It could be positive, negative, or even lukewarm.
...
> Your answer:
> The Response from the server I had trouble interacting with and dissecting the forms.
...
> Your answer (include code): Didn't get it functioning.
...
> Your answer: I am not a big phone app person to begin with as I mainly perfer a computer but probably and enhanced notes app that would be tailored to what I want. I have an amalgamated notes app that hobbles along with what I want it to do.
...
> Your answer: Always figure out how something you will learn is tied back to compostable.
